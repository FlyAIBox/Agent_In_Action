...
For more information, please refer to [our guide on Function Calling](https://qwen.readthedocs.io/en/latest/framework/function_call.html).

### Structured/JSON Output

SGLang supports structured/JSON output. Please refer to [SGLang’s documentation](https://docs.sglang.ai/backend/structured_outputs.html#OpenAI-Compatible-API). Besides, it is also recommended to instruct the model to generate the specific format in the system message or in your prompt.
