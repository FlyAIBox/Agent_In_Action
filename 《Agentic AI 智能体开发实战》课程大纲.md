...
| **02** | 多角色Agentic AI 智能体 | LangGraph, LangChain | 构建多角色协作的智能体骨架 | `02-agent-multi-role/` |
| **03** | Agentic AI 智能体系统构建与容器化部署 | FastAPI, Streamlit, LangGraph，Docker | 完整的前后端系统和生产环境部署 | `03-agent-build-docker-deploy/` |
...
#### 1.2 工具调用（Function Call）：大模型知识过时，如何获取实时信息？
...
#### 2.1 LangChain与LangGraph：简单调用到复杂系统，如何搭建？
...
#### 2.6 并行协作设计：多个智能体同时工作，如何避免混乱？

**核心问题：** 如何设计和实现多个专业智能体的并行协作系统？
...
#### 2.7 实战项目：深度研究助手（DeepResearch）- 智能文献调研系统如何设计？

**核心问题：** 如何构建一个能够自主进行文献调研和深度分析的智能体系统？
...
- `deepresearch/deployment/research_assistant.py` - 研究助手核心代码
- `deepresearch/deployment/docker-compose.yml` - Docker部署配置
- `deepresearch/deployment/langgraph.json` - LangGraph配置
- `deepresearch/deployment/doc/QUICKSTART.md` - 快速开始指南
- `deepresearch/deployment/doc/配置说明.md` - 详细配置文档
...
#### 5.3 LlamaFactory实战：微调工具复杂，如何快速上手？
...
#### 6.2 Transformers框架：基础推理工具，如何快速部署？
